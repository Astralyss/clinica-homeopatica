    ...
    <nav className="bg-white/80 backdrop-blur-lg border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-3 nav-link">
            <img src="/logo.svg" className="h-10 w-10" alt="logo consultorio homeopatico" />
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <Link href="/farmacia" className="nav-link">Farmacia</Link>
      ...
      {isOpen && (
        ...
        >
          <div className="px-4 py-4 flex flex-col space-y-3">
            ...
            <Link href="/farmacia" className="nav-link" onClick={() => setIsOpen(false)}>Farmacia</Link>
            ...
            <Link href="/agendarConsulta" onClick={() => setIsOpen(false)}>
              <button
